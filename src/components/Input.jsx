...
const Input = () => {
    ...
    return (
      <div className="transition ease-in delay-1000 lg:pt-12 pt-12 w-4/5 flex flex-col items-center justify-between gap-8 min-h-full overflow-hidden">
        ...
        <form className="flex flex-col items-center justify-betweem w-full lg:w-2/5" onSubmit={handleSubmit}>
          <input type="text" placeholder="I am" className="p-2 rounded w-4/5 h-12 text-black font-medium" value={inputValue} onChange={handleInput} />
